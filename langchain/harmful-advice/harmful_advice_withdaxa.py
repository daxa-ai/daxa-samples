...
from daxa_langchain.callback import DaxaCallbackHandler
from daxa_langchain.loader import DaxaSafeLoader
...
class HarmfulAdvicePDF:
    ...
    def ask(self, query: str):
        return self.retriever.run(query, callbacks=[
            DaxaCallbackHandler.from_credentials(app_id=self.app_name)
        ])
